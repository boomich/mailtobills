				...
				<CardContent className="grid p-0 md:grid-cols-2">
                    ...
                    >
                      Forgot your password?
							...
							<FieldSeparator className="*:data-[slot=field-separator-content]:bg-background [&_[data-slot=field-separator-content]]:font-mono [&_[data-slot=field-separator-content]]:text-[11px] [&_[data-slot=field-separator-content]]:tracking-[0.1em] [&_[data-slot=field-separator-content]]:uppercase flex items-end">
								{t("continueWith")}
							</FieldSeparator>
					...
					<div className="relative hidden border-l border-foreground bg-secondary p-10 md:flex md:flex-col md:justify-between">
						...
						<div className="flex items-center mx-auto justify-between gap-4">
							<div className="flex items-center gap-2.5">
								<Postmark className="h-[120px] w-auto shrink-0 text-foreground" />
							</div>
						</div>
